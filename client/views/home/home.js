...
Template.HomeView.events({
	...
	"click #dataview-export-default": function(e, t) {
		e.preventDefault();
		HomeViewExport(this.sensors, "csv");
	},
	...
	"click #dataview-export-tsv": function(e, t) {
		e.preventDefault();
		HomeViewExport(this.sensors, "tsv");
	},

	"click #dataview-export-json": function(e, t) {
		e.preventDefault();
		HomeViewExport(this.sensors, "json");
	}
...
Template.HomeView.helpers({
	...
	"isEmpty": function() {
		return !this.sensors || this.sensors.count() == 0;
	},
	"isNotEmpty": function() {
		return this.sensors && this.sensors.count() > 0;
	},
	"isNotFound": function() {
		return this.sensors && pageSession.get("HomeViewSearchString") && HomeViewItems(this.sensors).length == 0;
	},
...
Template.HomeViewTable.helpers({
	"tableItems": function() {
		return HomeViewItems(this.sensors);
	}
});
